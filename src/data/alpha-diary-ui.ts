...
const alphaDiaryUi = {
  ja: {
    ...
    replay: '最終演出を再生する',
    resetConfirm:
      'この端末につけたしおりを外しますか？ 日記そのものは削除されません。',
  ...
  en: {
    ...
    resetConfirm:
      'Remove the bookmark kept on this device? The shared diary entries will not be deleted.',
  ...
  'zh-cn': {
    ...
    replay: '重播最终演出',
    resetConfirm: '移除此设备上的书签吗？共享日记本身不会被删除。',
    resetProgress: '移除书签',
    retry: '重新打开',
  ...
  es: {
    ...
    resetConfirm:
      '¿Quitar el marcador guardado en este dispositivo? Las entradas compartidas no se borrarán.',
  ...
  pt: {
    ...
    resetConfirm:
      'Remover o marcador salvo neste dispositivo? As páginas compartilhadas não serão apagadas.',
  ...
  fr: {
    ...
    resetConfirm:
      'Retirer le marque-page enregistré sur cet appareil ? Les pages partagées ne seront pas supprimées.',
  ...
  ko: {
    ...
    replay: '마지막 연출 다시 보기',
    resetConfirm:
      '이 기기에 남긴 책갈피를 뺄까요? 공유된 일기 자체는 삭제되지 않습니다.',
  ...
  de: {
    ...
    resetConfirm:
      'Das Lesezeichen auf diesem Gerät entfernen? Die gemeinsam genutzten Einträge bleiben erhalten.',
  ...
  ru: {
    ...
    resetConfirm:
      'Убрать закладку, сохранённую на этом устройстве? Общие страницы дневника не удалятся.',
