...
const strings: Record<Locale, readonly string[]> = {
  ...
  en: [
    ...
    'Creating. This may take 1–2 minutes.',
    'Ready.',
  ...
  es: [
    ...
    'Creando. Puede tardar 1–2 minutos.',
    'Todo listo.',
  ...
  pt: [
    ...
    'Criando. Pode levar 1–2 minutos.',
    'Tudo pronto.',
  ...
  fr: [
    ...
    'Création en cours. Cela peut prendre 1 à 2 minutes.',
    'Prêt.',
  ...
  de: [
    ...
    'Wird erstellt. Das kann 1–2 Minuten dauern.',
    'Bereit.',
  ...
  ru: [
    ...
    'Создаём. Это может занять 1–2 минуты.',
    'Готово.',
