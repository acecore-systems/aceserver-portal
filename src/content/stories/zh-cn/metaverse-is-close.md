...
换一个角度，就会发现一个巨大的元宇宙已经存在，那就是 Minecraft。
...
运营 Minecraft 服务器，也是在培育一个小型虚拟空间。在 Aceserver，玩家们交流、共同建造并享受活动。

元宇宙不是只有大企业才能创造的事物，它早已存在于社区的延长线上。我们希望能以更有趣的方式运用这些贴近生活的空间。

加入方式和当前服务器简介请查看 [Aceserver Portal](/zh-cn/)。
