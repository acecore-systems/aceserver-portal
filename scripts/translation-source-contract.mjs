...
const SOURCE_MARKER_PATTERN =
  /<!-- portal-translation-source:([A-Za-z0-9_-]+) -->/gu
...
export function formatTranslationSourceMarker(contract) {
  ...
  return `<!-- portal-translation-source:${encoded} -->`
}

export function parseTranslationSourceMarker(body) {
